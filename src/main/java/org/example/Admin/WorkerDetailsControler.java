...
import org.example.Entity.DepartmentsRepositoryImpl;
...
public class WorkerDetailsControler implements Initializable {
    ...
    @FXML public ChoiceBox<String> positionChoiceBox;
    @FXML public ChoiceBox<String> departmentChoiceBox;
    @FXML public DatePicker enploymentDate;
    @FXML public DatePicker stackingDate;
    ...
    public void addWorkerToDB() {
        if (correctFirstname && correctLastname &&
            ...
            worker.setPassword(pass.getText());
    ...
    public void editWorkerInDB() {
        ...
        editWorker.setPassword(pass.getText());
        ...
        workersRepository.changeDadataWorker(editWorker);
    }
